...
We accept bug reports via issues created on [Github](https://github.com/thephpleague/uri-query-parser/issues).
...
- **Always try the [master branch](https://github.com/thephpleague/uri-query-parser)** - to see if the reported bug has not already been fixed.
